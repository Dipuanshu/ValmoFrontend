        ...
        <div className="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              accessing or using Valmo's website "valmodeliver.in", any of the
              offline businesses run under the brand name Valmo, mobile
              application and any of the platforms/tools developed by us from
              time to time (together referred to as "Platform"). These Terms
              along with the Privacy Policy published on our website ("Privacy
              Policy") and other policies (as may be
              notified/displayed/published on our website/mobile application or
              any other tool or platform as may be notified to you) constitutes
              a legally binding contract between you and the Company. By use of
              our Platform, you agree to be bound by these Terms and any other
              policies as mentioned above as updated from time to time.
            </p>
            ...
            <p className="text-sm">
              ...
              they install, download any tool, visit or access the website or
              any of the tools/platforms of Valmo, or utilize our online or
              offline Platform, which include without limitation browsers,
              Suppliers, merchants, purchasers or contributors of content and
              onboarded Partners (collectively, "User/You").
            </p>

            <p className="text-sm">
              These terms are applicable from the date on which any of our tool
              or application is downloaded/website is accessed or online or
              offline services are utilized or signed up for and/or the date on
              which terms of agreement (i.e., our Terms and any other Valmo
              policies) is updated, creating a legally binding arrangement
            ...
            <p className="text-sm">
              Users can review the most current version of the Terms and any
              other Vamo policies at any time on Valmo website. Company reserves
              the right to unilaterally update, change or replace them at any
              time and such amended provisions of the Terms or any other Valmo
              policy shall be effective immediately upon being posted on the
              website.
            </p>
            ...
            <p className="text-sm">
              ...
              advised to refrain from using the Platform. By use of the
              Platform, it is signified that the User agrees to abide by all our
              Terms and/ or policies (as updated from time to time).
            </p>
            ...
            <p className="text-sm">
              ...
              time of onboarding or registration, as further detailed under the
            ...
            <p className="text-sm">
              The Company reserves the right to suspend or terminate the access
              to the Platform (or any part thereof), including blocking any
              amounts due to the User and associated account without notice and
              the Users will remain liable for all amounts due up to and
            ...
            <ul className="list-disc pl-6 text-sm space-y-2 mt-2">
              ...
              <ul className="list-circle pl-6 text-sm space-y-2 mt-2">
                <li>
                  engaged in actions that are unlawful, fraudulent, negligent or
                  derogatory to the Company's interests;
                </li>
                <li>
                  failed or is suspected to have failed to comply with any term
                  or provision of the any agreement executed between you and the
                  Company or incase there are any issues in performance or
                  breach of metrics identified in the agreement executed between
                  you and the Company or breach of applicable law by you;
                </li>
                <li>
                  User is found to be non-compliant with these Terms or any
                  other agreement executed with the Company.
                </li>
              </ul>
            </ul>
            ...
            <p className="text-sm">
              Without prejudice to the above stated rights of the Company, in
              case of alleged fraud or other breach of these terms by User,
              Company may at its sole discretion (a) withhold all amounts
              payable to such User; and (b) impose penalties as the Company may
              reasonably determine and set off such penalties from the monies
            ...
            <p className="text-sm">
              ...
              User has failed to comply with any of the provisions of these
              Terms or any other agreement executed between you and the Company.
              Company shall have all the rights to take necessary action and
              claim damages that may occur due to User's
              involvement/participation in any way either on their own or
              through group/s of people, intentionally or unintentionally in
              hacking.
            </p>
            ...
            <p className="text-sm">
              User acknowledges and agrees that having access to Platform does
              not grant it any rights in respect to such Platform, Valmo's
              website or any tools or applications created pursuant to it unless
              such a right is specifically granted to them by the Company. The
              User understands that all the rights in and to the Platform are
              and shall forever be owned by and inure to the benefit of the
              Company.
            </p>

            <p className="text-sm">
              All information displayed, transmitted or carried on by the
              Company is protected under applicable laws. All rights, including
              copyright, in this website or any other information belonging to
              the Company are owned by the Company.
            </p>

            <p className="text-sm">
              The Platform is provided solely for the use of current and Users
              to interact with Valmo and may not be used by any other person or
            ...
            <p className="text-sm">
              ...
              transmit, distribute, adapt, reproduce, create derivative work
              from, repost, display, decompile, reverse engineer, disassemble or
              in any way commercially exploit any of the content available on
              the Platform, or any other tool or application run under the brand
              name of Valmo. Without the prior written consent of the owner,
            ...
            <ul className="list-disc pl-6 text-sm space-y-2 mt-2">
              <li>
                ...
                in any manner whatever on any topic, name, material or
                information on Valmo website or any related tool or application;
              </li>
              <li>
            ...
            <p className="text-sm">
              ...
              misrepresent their identity or affiliation with any person or
              entity in trying to access or use the Platform. User shall not
              forge headers or otherwise manipulate identifiers in order to
              disguise the origin of any message or transmittal User sends to
              Valmo on or through the Platform. You shall not pretend that you
              are, or that you represent, someone else, or impersonate any other
              individual or entity;
            </p>

            <p className="text-sm">
              User will not or attempt to delete or modify any content of
              Valmo's website or any related tools or applications, including
              but not limited to, disclaimers or proprietary notices such as
              copyright or trademark symbols, logos;
            </p>
            ...
            <p className="text-sm">
              ...
              law, as amended from time to time, including that of (i) the
              Information Technology Act, 2000 and the rules thereunder; (ii)
              ...
              in force); and (iii) international laws, foreign exchange laws,
              statutes, ordinances and regulations (including, but not limited
              to Direct and Indirect Taxes applicable as per current statue in
              the country) regarding the use of the Platform. The User shall not
              engage in any transaction which is prohibited by the provisions of
            ...
            <p className="text-sm">
              You will not use any deep-link, page-scrape, robot, spider or
              ...
              monitor any portion of the Valmo website or content, or in any way
              reproduce or circumvent the navigational structure or presentation
              of the website, to obtain or attempt to obtain any materials,
            ...
            <p className="text-sm">
              ...
              hacking, password "mining" or any other illegitimate means. You
            ...
            <p className="text-sm">
              ...
              statement(s) or comment(s) about Valmo/the Company or the brand
              name or domain name used by Valmo/Company or otherwise engage in
              any conduct or action that might tarnish the image or reputation
              of Valmo/the Company/Platform or otherwise tarnish or dilute any
              Valmo trade or service marks, trade name and/or goodwill
              associated with such trade or service marks, tradename as may be
              owned or used by us.
            </p>

            <p className="text-sm">
              On registration, the Users may receive a password protected
              account and an identification. The Users agree to: maintain the
            ...
            <p className="text-sm">
              ...
              or use of Platform. The requirement for registration and
              compliances under the GST Laws and other tax laws is the sole
              responsibility of the User, the Company is not liable for any
              omissions or commissions by such User who acts in violation of any
              applicable law. Accordingly, User is advised to seek independent
              tax advice relating to its business and/or transaction in relation
              to the Platform.
            </p>
            ...
            <p className="text-sm">
              ...
              accurate. However, the material and content provided in these
              forums is provided for general information only and should not be
            ...
            <p className="text-sm">
              ...
              required by law. Any reliance on the material on our website or
              any other tools or applications is at the Users' own risk.
            </p>
            ...
            <p className="text-sm">
              ...
              only. The Company reserves the right to modify the contents of its
              website and/or any other tools or applications at any time but has
              no obligation to update any information on its website or any
              other tools or applications.
            </p>

            <p className="text-sm">
              User is solely responsible to monitor changes to the information
              on our website or any other tools or applications. No specified
              update or refresh date applied to our website or any other tools
              or applications should be taken to indicate that all information
              on our website or any other tools or applications or pertaining to
              the Platform have been modified or updated.
            </p>
            ...
            <p className="text-sm">
              ...
              pertaining to the pricing, promotions, offers, transit times and
            ...
            <p className="text-sm">
              ...
              thereon and your ability or inability to access or use the
              Platform.
            </p>

            <p className="text-sm">
              Without prejudice to the forgoing paragraph, Valmo does not
              warrant that:
            </p>

            <ul className="list-disc pl-6 text-sm space-y-2 mt-2">
              <li>
                The Platform's (or a part thereof's) availability at all times;
                or
              </li>
              <li>
            ...
            <p className="text-sm">
              Certain content available on our website may include materials
              from third parties. Third-party links may direct User to
              third-party websites that are not affiliated with the Company. The
              Company is not responsible for examining or evaluating the content
              or accuracy and does not warrant and will not have any liability
              or responsibility for any third-party materials or websites, or
            ...
            <p className="text-sm">
              ...
              websites regardless of the existence of any third-party link.
              Please review carefully such third-party's policies and practices
              and make sure to understand them before engaging in any
              transactions.
            </p>

            <h2 className="text-xl font-semibold text-blue-300 mt-6 mb-3">
              Can Users use the content published on our website such as the
              "Valmo" mark when doing business with other parties?
            </h2>
            <p className="text-sm">
              Users may not use any trademark, service mark or logo of any
              independent third parties without prior written approval from such
              parties.
            </p>

            <p className="text-sm">
              "Valmo" and related icons and logos whether registered or
              unregistered are the trademarks of the Company and are protected
              under applicable copyright, trademark and other proprietary and
              intellectual property laws. Users' unauthorized adoption, copying,
              modification, use or publication of these marks is strictly
              prohibited.
            </p>

            <p className="text-sm">
              Users must not modify the paper or digital copies of any materials
              created in relation to the Platform. They must not use any
              illustrations, photographs, video or audio sequences or any
              graphics separately from any accompanying text.
            </p>

            <p className="text-sm">
              Users must not use any part of the content on Valmo website or any
              of our tools or applications for commercial purposes without
              obtaining a license to do so from the Company. All rights, not
              otherwise claimed under these Terms or any other agreement
              executed between the Company and you are hereby reserved.
            </p>

            <p className="text-sm">
              User understands that Valmo website or any of our tools or
              applications and software embodied within them may include
              ...
              Company or other parties that facilitate the same.
            </p>

            <p className="text-sm">
              User agrees that it will not attempt to override, disable,
              circumvent, or otherwise interfere with any such security
              components and usage rules embedded in Valmo website or any of our
              tools or applications.
            </p>

            <h2 className="text-xl font-semibold text-blue-300 mt-6 mb-3">
              What are the standard disclaimers in relation to the Platform?
            </h2>
            <p className="text-sm">
              All services provided under Valmo's brand name are provided by
              Partners and the Company, in no event, is or will be liable to
              User including or anyone claiming through a User in respect of
              Services under contract, negligence, strict liability or other
              legal or equitable theory for any special, incidental, indirect,
              consequential, exemplary or punitive damages, loss of goodwill,
              loss of revenue, loss of opportunity, loss of anticipated profits,
              whatsoever, including those resulting from loss of use, data or
              profits, whether or not foreseeable or whether or not Company has
              been advised of the possibility of such damages, or based on any
              theory of liability, including breach of contract or warranty or
              negligence or any other claim arising out of or in connection with
              the use of or access of the Platform.
            </p>

            <p className="text-sm">
              Company shall not be liable for: any injury, loss, claim, or any
              ...
              arising from the use of Platform, or for any other claim related
              in any way to the use of Platform, including, but not limited to,
              any errors or omissions in any content, or any loss or damage of
              any kind incurred as a result of the use of the Platform or any
              content posted, transmitted, or otherwise made available via the
              website or any other tools or applications, even if advised of
              their possibility.
            </p>

            <p className="text-sm">
              Users shall be solely responsible for damages, if any, to their
              data system or for loss of data arising from download of content
              from our website or any other tools or applications. No guidance
              or information, written or oral, obtained from Company, shall
            ...
            <p className="text-sm">
              ...
              indirectly affecting Company and/or the Platform. Examples of
              force majeure events include without limitation real or potential
              labour disputes, governmental actions, war or threat of war,
              sabotage, civil unrest, demonstrations, fire, storm, flooding,
              explosion, earthquake, epidemic or pandemic, provisions or
            ...
            <p className="text-sm">
              Force majeure or other events beyond the Company's control
              entitles the Company to suspend or limit the Platform until
              further notice.
            </p>
            ...
            <p className="text-sm">
              ...
              Company at support@valmodeliver.in. Murthy SN is the designated
              Grievance Officer in respect of this Agreement. Any complaints or
              concerns with regard to the Platform or any breach of this
              Agreement can be directed to the designated Grievance Officer in
              writing at the following address: 3rd Floor, Wing-E, Helios
              Business Park, Kadubeesanahalli Village, Varthur Hobli, Outer Ring
              Road Bellandur, Bangalore, Bangalore South, Karnataka, India,
              560103
            </p>
            ...
            <p className="text-sm">
              ...
              provision shall be severed from the remaining provisions which
            ...
            <p className="text-sm">
              ...
              callers/messengers who may impersonate themselves as
              representatives of the Company. The Company's authorized
              representatives will never contact the Users to demand money for
              allocation of hubs or other business opportunities with Valmo, for
              prizes or ask for password/PIN/CVV. In the event you are asked for
              confidential details by anyone posing as the Company's
              representatives, please ask them to communicate with you through
              email and only respond to emails from the valmo.com domain.
            </p>
            ...
            <p className="text-sm">
              ...
              Users' calls may be recorded to ensure quality of service.
            ...
            <p className="text-sm">
              ...
              third-party claims, or actions including reasonable attorneys'
              fees, made by any third party or penalty imposed due to or arising
              out of your breach of these terms of use, Privacy Policy and other
              terms and conditions, or your violation of any law, rules or
              regulations or the rights (including infringement of intellectual
              property rights) of a third party, wilful misconduct and gross
              negligence and any of your activities conducted in connection with
              the Platform.
            </p>
            ...
            <p className="text-sm">
              These terms are governed by the laws of India. Any action, suit,
              or other legal proceeding, which is commenced to resolve any
              matter arising under or relating to these Terms or the Platform
              provided by the Company shall be subject to the jurisdiction of
              the courts at Bangalore, India.
            </p>
