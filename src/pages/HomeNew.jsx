    ...
    <div className="font-sans relative">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="hidden md:flex bg-gradient-to-r from-cyan-400 to-blue-300 w-full md:w-1/2 p-10 h-[400px] flex-col justify-center">
          ...
          <button className="bg-[#0B2A4A] text-white px-6 py-2 rounded shadow hover:bg-blue-900 w-fit">
            Join us Now
          </button>
        </div>
      ...
      {/* Sub Section */}
      <section className="bg-[#0B2A4A] text-white px-6 py-20 text-center md:text-left">
        <h3 className="text-xl md:text-2xl font-bold mb-3">
          We are a trusted partner in simplifying logistics
        </h3>
        <p className="max-w-3xl">
          Our aim is to streamline the logistics process - offering a smooth and
          efficient delivery experience, all while delivering excellent value by
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-20">
          ...
          <div className="w-full md:w-1/2 bg-white rounded-xl shadow-md p-6">
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-700 text-[16px]">
              <li>Earn ₹15,000 – ₹30,000/month with flexible working hours</li>
            ...
            <button className="bg-[#0B2A4A] text-white px-6 py-2 rounded mt-6 shadow hover:bg-blue-900">
              Join us Now
            </button>
          </div>
        </div>
      ...
      <footer className="bg-[#0B2A4A] text-white mt-20 pt-10 pb-6 px-6">
        ...
        <div className="max-w-7xl mx-auto mt-6 border-t border-gray-500 pt-4 text-xs text-gray-300">
          <p className="italic">
            ...
            email addresses (@valmo.in or @meesho.com). Kindly DO NOT interact
            with any communications or requests for payments from any other
            sources or share any personal information.
          </p>
